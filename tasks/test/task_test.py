...
@mock.patch('tasks.tasksviews.task_views.TaskSerializer')
class TestTaskViews(unittest.TestCase):
    ...
    def postreq(self):
        with mock.patch('tasks.tasksviews.task_views.requests.post'):
...
class TestUpdateTaskViews(unittest.TestCase):
    ...
    def putreq(self):
        with mock.patch('tasks.tasksviews.task_views.requests.put'):
...
@mock.patch('tasks.tasksviews.TaskSerializer')
class TestDeleteTaskViews(unittest.TestCase):
    ...
    def test_delete_task(self):
        with mock.patch('tasks.tasksviews.task_views.requests.delete'):
...
class TestGetTaskViews(unittest.TestCase):
    ...
    def test_get_task(self):
        with mock.patch('tasks.tasksviews.task_views.requests.get'):
